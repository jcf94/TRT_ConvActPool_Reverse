...
static void run_packed_ab_case(const Args& args, const char* name,
  ...
  float ms = time_kernel([&] {
    fused_ptx_mma_oc32_dual_n_packed_ab_kernel<TILE, WARPS>
...
int main(int argc, char** argv) {
  ...
  run_packed_ab_case<4, 4, 128>(
      args, "ptx_mma_oc32_dual_n_packed_ab_4x4", d_x, d_w_mma4, d_y, shift,
      h_ref, h_y);
  run_packed_ab_case<4, 2, 64>(
      args, "ptx_mma_oc32_dual_n_packed_ab_4x4_w2_b64", d_x, d_w_mma4, d_y,
      shift, h_ref, h_y);
  run_packed_ab_case<4, 4, 160>(
      args, "ptx_mma_oc32_dual_n_packed_ab_4x4_w4_b160", d_x, d_w_mma4, d_y,
      shift, h_ref, h_y);
  run_packed_ab_case<4, 4, 192>(
      args, "ptx_mma_oc32_dual_n_packed_ab_4x4_w4_b192", d_x, d_w_mma4, d_y,
      shift, h_ref, h_y);
  run_packed_ab_case<4, 4, 224>(
      args, "ptx_mma_oc32_dual_n_packed_ab_4x4_w4_b224", d_x, d_w_mma4, d_y,
      shift, h_ref, h_y);
  run_packed_ab_case<4, 4, 256>(
      args, "ptx_mma_oc32_dual_n_packed_ab_4x4_w4_b256", d_x, d_w_mma4, d_y,
      shift, h_ref, h_y);
  run_packed_ab_case<4, 4, 288>(
      args, "ptx_mma_oc32_dual_n_packed_ab_4x4_w4_b288", d_x, d_w_mma4, d_y,
      shift, h_ref, h_y);
  run_packed_ab_case<4, 4, 320>(
      args, "ptx_mma_oc32_dual_n_packed_ab_4x4_w4_b320", d_x, d_w_mma4, d_y,
      shift, h_ref, h_y);
  run_packed_ab_case<4, 8, 192>(
      args, "ptx_mma_oc32_dual_n_packed_ab_4x4_w8_b192", d_x, d_w_mma4, d_y,
      shift, h_ref, h_y);
  run_packed_ab_case<4, 8, 224>(
      args, "ptx_mma_oc32_dual_n_packed_ab_4x4_w8_b224", d_x, d_w_mma4, d_y,
      shift, h_ref, h_y);
  run_packed_ab_case<4, 8, 256>(
      args, "ptx_mma_oc32_dual_n_packed_ab_4x4_w8_b256", d_x, d_w_mma4, d_y,
      shift, h_ref, h_y);
  run_packed_ab_case<4, 8, 288>(
      args, "ptx_mma_oc32_dual_n_packed_ab_4x4_w8_b288", d_x, d_w_mma4, d_y,
      shift, h_ref, h_y);
  run_packed_ab_case<4, 8, 320>(
      args, "ptx_mma_oc32_dual_n_packed_ab_4x4_w8_b320", d_x, d_w_mma4, d_y,
      shift, h_ref, h_y);
  run_packed_ab_case<5, 4, 128>(
      args, "ptx_mma_oc32_dual_n_packed_ab_5x5", d_x, d_w_mma4, d_y, shift,
      h_ref, h_y);
  run_packed_ab_case<6, 4, 128>(
      args, "ptx_mma_oc32_dual_n_packed_ab_6x6", d_x, d_w_mma4, d_y, shift,
      h_ref, h_y);
  run_packed_ab_case<7, 4, 128>(
      args, "ptx_mma_oc32_dual_n_packed_ab_7x7", d_x, d_w_mma4, d_y, shift,
      h_ref, h_y);
