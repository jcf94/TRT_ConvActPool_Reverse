...
__global__ void fused_ptx_mma_oc32_parallel_pool_kernel(
...
static void run_case(const Args& args, const char* name, const int8_t* d_x,
  ...
  float ms = time_kernel([&] {
    fused_ptx_mma_oc32_parallel_pool_kernel<TILE, WARPS>
...
int main(int argc, char** argv) {
  ...
  run_case<4, 8, 256>(args, "ptx_mma_oc32_parallel_pool_4x4_w8_b256", d_x,
                      d_w_mma4, d_y, shift, h_ref, h_y);
  run_case<4, 8, 224>(args, "ptx_mma_oc32_parallel_pool_4x4_w8_b224", d_x,
                      d_w_mma4, d_y, shift, h_ref, h_y);
  run_case<4, 4, 256>(args, "ptx_mma_oc32_parallel_pool_4x4_w4_b256", d_x,
                      d_w_mma4, d_y, shift, h_ref, h_y);
  run_case<5, 4, 128>(args, "ptx_mma_oc32_parallel_pool_5x5_w4_b128", d_x,
                      d_w_mma4, d_y, shift, h_ref, h_y);
  run_case<6, 4, 128>(args, "ptx_mma_oc32_parallel_pool_6x6_w4_b128", d_x,
                      d_w_mma4, d_y, shift, h_ref, h_y);
  run_case<7, 4, 128>(args, "ptx_mma_oc32_parallel_pool_7x7_w4_b128", d_x,
                      d_w_mma4, d_y, shift, h_ref, h_y);
