...
__global__ void fused_oc64_i8pool_kernel(
...
static void run_case(const Args& args, const char* name, const int8_t* d_x,
  ...
  auto k = fused_oc64_i8pool_kernel<TILE, WARPS, OC_GROUPS>;
...
int main(int argc, char** argv) {
  ...
  run_case<8, 8, 4, 256>(args, "v38_oc64_wide_pool_8x8_b256", d_x, d_w_mma4, d_y, shift, h_ref, h_y);
  run_case<7, 8, 4, 256>(args, "v38_oc64_wide_pool_7x7_b256", d_x, d_w_mma4, d_y, shift, h_ref, h_y);
  run_case<4, 8, 4, 256>(args, "v38_oc64_wide_pool_4x4_b256", d_x, d_w_mma4, d_y, shift, h_ref, h_y);
